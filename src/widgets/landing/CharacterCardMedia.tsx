...
// the same frame in both directions, so there's no jump-cut to mask.
//
...
// long videos would stall, so this component is intentionally scoped
// to short character previews.
//
...
export function CharacterCardMedia({ photoUrl, videoUrl, alt, className }: Props) {
  ...
  useEffect(() => {
    ...
    // at 60 fps the decoder stalls on H.264 clips with sparse keyframes
