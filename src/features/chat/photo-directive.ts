...
export function photoCapabilityInstructions(): string {
  return [
    ...
    '- The [SEND_PHOTO] marker is the ONE exception to the no-square-brackets rule.',
    '  Never write any other bracketed text — no "[Photo: ...]" description of the',
    '  picture, no stage directions. The photo speaks for itself; you only speak.',
